...
public class ProyectoExamen extends JFrame implements ActionListener, ItemListener {
    ...
    public void actionPerformed(ActionEvent e) {
        ...
        if (e.getSource() == pelicula) {
            ...
            if (salas.equals("Los Boxtrolls")) {
                ...
                box.paintIcon(this, papel, 0, 0);
                sala1.setText("1");
            }
            if (salas.equals("Las Tortugas Ninja")) {
                Graphics papel = cartel.getGraphics();
                Object origen = e.getSource();
                tor.paintIcon(this, papel, 0, 0);
                sala1.setText("2");
            }
            if (salas.equals("Cantinflas")) {
                Graphics papel = cartel.getGraphics();
                Object origen = e.getSource();
                can.paintIcon(this, papel, 0, 0);
                sala1.setText("5");
            }
            if (salas.equals("En el Tornado")) {
                Graphics papel = cartel.getGraphics();
                Object origen = e.getSource();
                torna.paintIcon(this, papel, 0, 0);
                sala1.setText("3");
            }
            if (salas.equals("Ninfomania")) {
                Graphics papel = cartel.getGraphics();
                Object origen = e.getSource();
                ninfo.paintIcon(this, papel, 0, 0);
                sala1.setText("6");
            }
            if (salas.equals("Lucy")) {
                Graphics papel = cartel.getGraphics();
                Object origen = e.getSource();
                lucy.paintIcon(this, papel, 0, 0);
                sala1.setText("4");
            }
        }
        ...
        if (e.getSource() == login2) {
            ...
            if ((U.equals("root")) && (C.equals("1234"))) {
                ...
                if ((U.equals("Angel")) && (C.equals("133107033"))) {
                    ProyectoExamen marco = new ProyectoExamen();
                    marco.setSize(1200, 800);
                    marco.crearGUI();
                    marco.setVisible(true);
                    ...
                    if ((U.equals("q")) && (C.equals("q"))) {
                        ...
                        if ((U.equals("Oscar")) && (C.equals("133107032"))) {
                            ProyectoExamen marco = new ProyectoExamen();
                            marco.setSize(1200, 800);
                            marco.crearGUI();
                            marco.setVisible(true);
        ...
        if (e.getSource() == cambio) {
            double efec = 0;
            efec = Double.parseDouble(efectivo2.getText());
            double totalneto = 0;
            totalneto = Double.parseDouble(total.getText());
        ...
        if (e.getSource() == imprimir) {
            ...
            if (An.isSelected()) {
                ticket.append("          Atendio: Angel Olivares  " + "   Caja #3" + "\n");
            }
            if (Da.isSelected()) {
                ticket.append("         Atendio: Damian Martinez  " + "   Caja #2" + "\n");
            }
            if (Os.isSelected()) {
                ticket.append("          Atendio: Oscar Noriega  " + "   Caja #1" + "\n");
            }
            ...
            double ef = 0;
            ef = Double.parseDouble(efectivo2.getText());
            String ef2 = String.valueOf(ef);
            ticket.append("                                    Efectivo ............ $  " + ef2 + "\n");
            double c = 0;
            c = Double.parseDouble(cambio2.getText());
    ...
    public void itemStateChanged(ItemEvent event) {
        if (Descuento.isSelected()) {
            double descuento = 0;
            descuento = Double.parseDouble(Tsin.getText());
